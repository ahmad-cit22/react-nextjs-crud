...
export default function Table() {
  ...
  return (
    <table className="min-w-full table-auto">
      <thead>
        <tr className="bg-[#420303]">
          <th className="px-16 py-2">
            <span className="text-gray-200">Book Name</span>
          </th>
          <th className="px-16 py-2">
            <span className="text-gray-200">Genre</span>
          </th>
          <th className="px-16 py-2">
            <span className="text-gray-200">Author's Name</span>
          </th>
          <th className="px-16 py-2">
            <span className="text-gray-200">Publish Date</span>
          </th>
          <th className="px-16 py-2">
